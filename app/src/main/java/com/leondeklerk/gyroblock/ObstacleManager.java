...
public class ObstacleManager {
    ...
    public void update(){
        ...
        float speed = (float)(Math.sqrt(1 + (startTime - initTime)/3000)) * Constants.SCREEN_HEIGHT/10000.0f;
        for(Obstacle ob : obstacles){
        ...
        score();
        int curTopScore = Integer.valueOf(preferences.getString("high_score", "0"));
